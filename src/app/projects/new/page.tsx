...
const ImpactForm = () => {
  ...
  return (
    <fieldset className="space-y-1.5">
      <legend className="font-mono text-sm font-medium leading-none">
        Potential impact
      </legend>
...
const TechForm = () => {
  ...
  const tech = Array.isArray(techArray)
    ? techArray.filter(({ value }) => Boolean(value))
    : []
        ...
        <Popover>
          <PopoverTrigger asChild>
            <FormControl>
              ...
              >
                Select technologies
                <span className="material-symbols-sharp ml-2 h-6 w-6 shrink-0 opacity-50">
                  unfold_more
                </span>
              </Button>
            </FormControl>
                  ...
                  >
                    <span
                      className={cn(
                        ...
                        tech.some(({ value }) => value === item.value)
                          ? "opacity-100"
                          : "opacity-0",
                      )}
                    >
        ...
        {Array.isArray(tech) &&
          ...
          tech.map((item, index) => (
            <li key={item.value} className="flex">
              <Badge variant="secondary" className="select-none rounded-none">
                <svg
                  aria-hidden
                  viewBox="0 0 24 24"
                  width={20}
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Textarea
                      placeholder="A website for cfc members to register"
                      {...field}
                    />
                  </FormControl>
                  <FormMessage />
                    ...
                    <PopoverTrigger asChild>
                      <FormControl>
                        ...
                        >
                          ...
                          <span className="material-symbols-sharp ml-auto h-6 w-6 opacity-50">
                            date_range
                          </span>
                        </Button>
                      </FormControl>
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input
                      type="url"
                      placeholder="https://github.com/codersforcauses"
                      {...field}
                    />
                  </FormControl>
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input
                      type="url"
                      placeholder="https://codersforcauses.org"
                      {...field}
                    />
                  </FormControl>
