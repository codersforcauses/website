          ...
          <div className="space-y-4 pl-10">
            <div>
              ...
              <ul className="list-disc pl-5 space-y-1">
                <li>
                  How can tenants, especially those with limited English or digital literacy, easily find and understand
                  housing options and their rights?
                </li>
                <li>
            ...
            <div>
              ...
              <ul className="list-disc pl-5 space-y-1">
                ...
                <li>
                  What tools could empower tenants to make their housing more energy efficient, sustainable, and cheaper
                  to maintain?
                </li>
                <li>
            ...
            <div>
              ...
              <ul className="list-disc pl-5 space-y-1">
                <li>
                  How might emergency shelters or temporary accommodation providers connect more quickly with people in
                  need, in real time?
                </li>
                <li>What systems could reduce the gap between applying for crisis housing and being placed into it?</li>
                <li>
                  How could technology help frontline workers (social workers, case managers, volunteers) coordinate and
            ...
            <div>
              ...
              <ul className="list-disc pl-5 space-y-1">
                ...
                <li>
                  How might mapping or predictive data tools help identify areas most at risk of homelessness or housing
                  stress?
                </li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="list-disc pl-5 space-y-1">
                ...
                <li>
                  What do vulnerable people sacrifice first (food, medicine, travel) when housing becomes unaffordable?
                </li>
                <li>
            ...
            <div>
              ...
              <p>
                This hackathon is open-ended, you decide what “improving housing” means. Your solution could be an app,
                a platform, a data tool, or even a community initiative.
              </p>
              <p>
