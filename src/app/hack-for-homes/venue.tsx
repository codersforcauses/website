            ...
            <div className="space-y-4 pl-10">
              ...
              <div>
                ...
                <ul className="list-disc pl-5 space-y-1">
                  <li>
                    As St Catherine’s is a residential college, the doors require swipe card access outside office
                    hours.
                  </li>
                  <li>
                  ...
                  <li>
                    Outside these times, someone inside must press the green button to let you back in. Please
                    coordinate with your team or a CFC organiser if you plan to leave and return after these windows.
                  </li>
                </ul>
              </div>
              <Separator />
