...
const Server = (props: ServerProps) => (
  <svg xmlns="http://www.w3.org/2000/svg" data-name="Layer 1" viewBox="0 0 888 710.81" {...props}>
    ...
    <path fill="#3f3d56" d="M313 373.807h262v104H313zM313 489.807h262v104H313zM313 605.807h262v104H313z"></path>
    <path d="M313 417.904h262v16H313zM313 533.904h262v16H313zM313 649.904h262v16H313z"></path>
    <circle cx="{524}" cy="{388.807}" r="{6}"></circle> <circle cx="{545}" cy="{388.807}" r="{6}"></circle>
    <circle cx="{566}" cy="{388.807}" r="{6}"></circle> <circle cx="{524}" cy="{502.807}" r="{6}"></circle>
    <circle cx="{545}" cy="{502.807}" r="{6}"></circle> <circle cx="{566}" cy="{502.807}" r="{6}"></circle>
    <circle cx="{524}" cy="{616.807}" r="{6}"></circle> <circle cx="{545}" cy="{616.807}" r="{6}"></circle>
    <circle cx="{566}" cy="{616.807}" r="{6}"></circle> <path fill="#3f3d56" d="M0 708.807h888v2H0z"></path>
    <path
      fill="#e6e6e6"
    ...
    <path fill="#e6e6e6" d="M171.186 379.927h36.72v2.098h-36.72z"></path>
    <path d="M171.149 387.632h56.817v2.098h-56.817z"></path>
    <path
      fill="#e6e6e6"
    ...
    ></path>
    <path d="M154.533 386.582h4.197v4.197h-4.197z"></path>
    <path
      fill="#e6e6e6"
    ...
    <path fill="#e6e6e6" d="M376.789 57.542h48.927v2.796h-48.927z"></path>
    <path d="M376.74 67.807h75.705v2.796H376.74z"></path>
    <path
      fill="#e6e6e6"
    ...
    ></path>
    <path d="M354.601 66.409h5.592v5.592h-5.592z"></path>
    <path
      fill="#e6e6e6"
    ...
    ></path>
    <path d="M321.006 0H566.89v10.446H321.006z"></path>
    ...
    <path fill="#e6e6e6" d="M671.648 294.807h60v31h-60zM671.648 405.807h60v31h-60z"></path>
    <circle cx="{701.648}" cy="{365.807}" r="{50}" fill="#e6e6e6"></circle>
    <circle cx="{701.648}" cy="{365.807}" r="{39}" fill="#fff"></circle>
    <path fill="#e2e2e2" d="M688.877 355.122h30.247v1.728h-30.247z"></path>
    <path d="M688.846 361.468h46.802v1.728h-46.802z"></path>
    <path
      fill="#e2e2e2"
    ...
    ></path>
    <path d="M675.16 360.604h3.457v3.457h-3.457z"></path>
    <path
      fill="#e2e2e2"
