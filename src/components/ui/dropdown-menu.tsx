...
>(({ className, inset, children, ...props }, ref) => (
  ...
  >
    {children}
    <span className="material-symbols-sharp ml-auto">chevron_right</span>
  </DropdownMenuPrimitive.SubTrigger>
))
...
>(({ className, children, checked, ...props }, ref) => (
  <DropdownMenuPrimitive.CheckboxItem
    ...
    {...props}
  >
    <DropdownMenuPrimitive.ItemIndicator className="material-symbols-sharp absolute left-2 flex h-3.5 w-3.5 items-center justify-center">
      check
...
>(({ className, children, ...props }, ref) => (
  ...
  >
    <span className="absolute left-2 flex h-3.5 w-3.5 items-center justify-center">
      <DropdownMenuPrimitive.ItemIndicator>
        <span className="material-symbols-sharp text-xs text-current">check</span>
      </DropdownMenuPrimitive.ItemIndicator>
    </span>
    {children}
  </DropdownMenuPrimitive.RadioItem>
