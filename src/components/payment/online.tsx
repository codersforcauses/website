  ...
  return (
    <form className="grid gap-y-4 @container">
      ...
      <div
        id="apple-pay-button"
        className={cn(
          "h-10 overflow-hidden rounded-none focus-within:ring-2 focus-within:ring-ring focus-within:ring-offset-2 hover:cursor-pointer hover:bg-primary/90 dark:bg-white",
