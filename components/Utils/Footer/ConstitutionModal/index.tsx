  ...
  >
    <div className='pl-4 ml-6 leading-relaxed legal-content'>
        ...
        <li>
          ...
          <ul className='pl-3' role='list'>
            ...
            <li>
              ...
              affiliated societies representative of University interests.
            </li>
            <li>
              To do all such things as would appear necessary and proper for the
              benefit or advancement of members of the Club.
            </li>
          </ul>
        </li>
        <li>
          The property and income of the society shall be applied solely towards
          the promotion of the objectives of the club and no part of that
          property or income may be paid or otherwise distributed, directly or
          indirectly, to members, except in good faith and in the promotion of
          those objectives.
        </li>
      </ol>
      <h3 className='mb-2 font-mono text-xl font-black list-heading'>
      ...
      <ol role='list'>
        ...
        <li>
          Any potential member that meets the requirements in 3.1 has the right
          to join the club.
        </li>
      </ol>
      <h3 className='mb-2 font-mono text-xl font-black list-heading'>
      ...
      <ol role='list'>
        <li>
          ...
          has performed outstanding service to the Club.
        </li>
      </ol>
      <h3 className='mb-2 font-mono text-xl font-black list-heading'>
      ...
      <ol role='list'>
        <li>
          ...
          <ul className='pl-3' role='list'>
            ...
            <li>
              But shall otherwise have all the rights and privileges of ordinary
              membership.
            </li>
          </ul>
        </li>
      ...
      <ol role='list'>
        <li>
          ...
          club in each academic semester.
          <ol type='a' className='pl-4'>
            <li>
              The Club will hold its inaugural Annual General Meeting in March.
            </li>
          </ol>
        </li>
        <li>
        ...
        <li>
          ...
          the signatories of the requisition may do so. Any business set out in
          the requisition shall have priority over all the other business.
        </li>
      </ol>
      <h3 className='mb-2 font-mono text-xl font-black list-heading'>
      ...
      <ol role='list'>
        <li>
          ...
          least seven days before the date appointed for that meeting.
        </li>
        <li>
          No General Meeting may be held while a Guild General Meeting is in
          progress. This shall not apply where written notice of the meeting was
          given before written notice of the Guild General Meeting. Any such
          meeting being conducted in contravention thereof shall disband
          immediately on the order of disciplinary officer of the Guild.
        </li>
        <li>
          The quorum of General Meeting shall consist of 10 Financial Ordinary
          Membership for the time being.
        </li>
        <li>
          All General Meeting of the Club shall be conducted in accordance with
          the procedure prescribed in the Standing Rules and Orders of the Guild
          Council.
        </li>
        <li>
          ...
          <ol role='list'>
            ...
            <li>
              Be elected by the committee before nominations are declared open
            </li>
            <li>
      ...
      <ol role='list'>
        <li>
          ...
          succeeding Annual General Meeting; nominations shall close at that
          meeting.
        </li>
      </ol>
      <h3 className='mb-2 font-mono text-xl font-black list-heading'>
      ...
      <ol role='list'>
        <li>
          ...
          Committee of the Club. Nominations shall close at the commencement of
          that meeting or earlier if stated in the notice.
        </li>
        <li>
      ...
      <ol role='list'>
        <li>
          ...
          consist of, in order of seniority:
          <ul>
            <li>The President</li>
        ...
        <li>
          Only financial Ordinary Members of the Club who are also members of
          the Guild shall be eligible for election as Executive Office Bearers.
        </li>
        <li>
          Election shall be conducted by optional preferential ballot for each
          office in the order shown above.
        </li>
        <li>
          A Candidate defeated for one office may stand for any office lower on
          the list.
        </li>
        <li>
        ...
        <li>
          ...
          <ol role='list'>
            ...
            <li>
              Been given at least seven days’ notice of that Committee Meeting;
              and
            </li>
            <li>
              Been accorded the opportunity to be present and to speak at that
              Committee Meeting.
            </li>
          </ol>
        </li>
        ...
        <li>
          ...
          <ol role='list'>
            ...
            <li>
              ...
              optional preferential ballot of the Annual General Meeting
      ...
      <ol role='list'>
        ...
        <li>
          ...
          seven days’ notice before the date fixed for the meeting together with
        ...
        <li>
          ...
          of the members signing the requisition may do so. Any business set out
          in the requisition shall have priority over all other business.
        </li>
      </ol>
      <h3 className='mb-2 font-mono text-xl font-black list-heading'>
      ...
      <ol role='list'>
        ...
        <li>
          All meetings of the Committee shall be conducted in accordance with
          the procedure prescribed in the Standing Rules and Orders of the Guild
          Council.
        </li>
      </ol>
      ...
      <p>
        Subject to this Constitution, the Committee shall be responsible to the
        Club in General Meeting for giving effect to the Objectives of the Club
        as set out in Article 2 and elsewhere in this Constitution and for
      ...
      <ol role='list'>
        <li>
          ...
          enabling resolution of General Meeting, however, the Committee shall
          not borrow or raise money or incur debts or liabilities on behalf of
          or in the name of the Club to a greater amount than five dollars for
          each and every then existing financial Ordinary Member of the Club.
        </li>
        <li>
          Make regulations for the orderly and proper management of the affairs
          of the Club, ensuring that no regulation is inconsistent or repugnant
      ...
      <ol role='list'>
        ...
        <li>
          If the President is absent or does not wish to exercise his right at
          any meeting, that right shall develop upon the Vice President.
        </li>
        <li>
          In the event of absence of both the President and the Vice President,
          or in event of them both not wishing to exercise their right, that
        ...
        <li>
          ...
          <ol role='list'>
            ...
            <li>
              ...
              subject to the authority of the Club in General Meeting.
            </li>
            <li>
              See that all Office-Bearers are conversant with the Constitution
              and their respective Duties and Responsibilities
            </li>
            <li>Generally carry out the policy of the Club.</li>
            <li>
              Report on the status of the club to the ordinary members at all
              general meetings.
            </li>
          </ol>
        </li>
        ...
        <li>
          ...
          <ol role='list'>
            ...
            <li>
              ...
              projects, and oversee their delivery.
            </li>
        ...
        <li>
          ...
          <ol role='list'>
            ...
            <li>
              ...
              Minute Book which they shall cause to be provided for that
              purpose.
            </li>
            <li>
              ...
              <ul role='list'>
                <li>
                  ...
                  be recorded in the Guild register of the University societies.
                </li>
                <li>
                  To notify the Secretary of the Societies Council within
                  fourteen days of the alterations in the foregoing information.
                </li>
                <li>
                  To lodge with the Secretary of the Societies Council a copy of
                  the Constitution and any By-Laws made under its authority.
                </li>
              </ul>
            </li>
            <li>
              To notify the Secretary of the Societies Council within fourteen
              days from the making therefore of any alterations to this
              Constitution of such By-Laws.
            </li>
            <li>
              To notify the Secretary of the Societies Council of any apologies
              at least four days before meetings of the council in each calendar
              year.
            </li>
            <li>
              In the event of the Club being de-registered, to present to the
              Societies Council Secretary within thirty days a duly audited
              statement of the financial position of the Club together with a
              copy of the resolution, which may have been passed by the Club as
              to the disposition of its funds.
            </li>
          </ol>
        </li>
      </ol>
        ...
        <li>
          ...
          <ul>
            <li>
              ...
              accounts and information relating to the finances and property of
              the Club as the Committee from time to time require.
            </li>
            <li>
              Arrange and be responsible for handling of the petty cash and to
              render an account to each Committee member of all petty cash.
            </li>
            <li>
              Prepare a financial statement showing all receipts and payments
              during their term of office, for presentation with auditors report
              to the Annual General Meeting.
            </li>
            <li>
              Produce and deliver all necessary books, vouchers and other
              documents to the persons appointed by the Guild Finance Committee
              for the purpose of conducting an audit, in so far as such persons
              may so require.
            </li>
            <li>
      ...
      <ol role='list'>
        <li>
          ...
          for the credit of the Club.
        </li>
        <li>
          Any two members of the Executive may jointly sign cheques and forms of
          authority for the payment of funds of the Society.
        </li>
        <li>
          Notwithstanding anything contained herein, no persons shall deposit or
          withdraw any monies into any account that Guild Council has closed by
          resolution.
        </li>
      </ol>
      <h3 className='mb-2 font-mono text-xl font-black list-heading'>
      ...
      <ol role='list'>
        ...
        <li>
          ...
          severally responsible for such compliance, and shall be deemed liable
      ...
      <ol role='list'>
        <li>
          ...
          notification of such request to be served upon the member concerned.
        </li>
        <li>
          Should such a request prove ineffectual after fourteen days of written
          notification, the Committee may serve written notice of intended
          expulsion of the member concerned and should they not have resigned
          seven days after, the Committee may by unanimous vote expel him or her
          from the Club; but such expulsion shall be subject to review at the
          next General Meeting with the member present and to be heard.
        </li>
        <li>
          A person who has been expelled or has resigned their membership may
          not reapply for membership for the period of one year.
        </li>
      </ol>
      <h3 className='mb-2 font-mono text-xl font-black list-heading'>
      ...
      <ol role='list'>
        <li>
          ...
          President shall have the power to interpret the meaning of any of the
          provisions contained in the Constitution, but the determining decision
          in case of doubt shall rest with the Club in General Meeting.
        </li>
      </ol>
      <h3 className='mb-2 font-mono text-xl font-black list-heading'>
      ...
      <ol role='list'>
        <li>
          ...
          the Secretary a notice of motion signed by them proposing an
          alteration to this Constitution. This shall be posted on notice boards
          forthwith.
        </li>
        <li>
          The motion may then be considered by the Club at its next meeting and
          amendments that are relevant to the subject matter thereof may be
          moved without notice.
        </li>
        <li>
          The motion of any amendment thereto shall not be deemed adopted unless
          it receives a two-thirds majority of the members present and voting.
        </li>
        <li>
          The motion as adopted with any amendments shall come into force upon
          receiving the approval of the Societies Council.
        </li>
      </ol>
      <h3 className='mb-2 font-mono text-xl font-black list-heading'>
      ...
      <ol role='list'>
        <li>
          ...
          property shall be distributed to another association or club
          affiliated to the Societies Council which has similar objectives to
          those of the club, and which association shall be determined by
      ...
      <ul className='pl-4 leading-relaxed list-disc'>
        <li>
          ...
          <ol className='pl-6 ml-2 list-decimal'>
            <li>
              Removed role &ndash; Client Officer; merged responsibilities with
              Vice-President
            </li>
